...
| 모임광장 | 습지 동쪽, 서쪽 **평의자 3** · 수목보호대 1 | △ 그림은 아직 안내판 3개로 그려져 있음 — 아래 '남은 차이' 참조 |
...
남은 차이는 셋입니다. ① **모임광장 서쪽 셋이 안내판으로 그려져 있는데 실은 평의자**입니다 — 성운 답안 시설물 수량표가 평의자 8 · 안내판 6 · 종합안내판 1 이고, 안내판 6은 관찰데크 5 + 조류관찰소 1 로 이미 다 차므로 평의자 8 − 휴게공간 5 = 3 이 모임광장 몫입니다('My' 탭 조감도는 7회차에 평의자로 고쳤습니다). 이 그림은 아직 고치지 않았습니다. ② **저수지가 도면보다 조금 동쪽·넓습니다**(도면 부지 폭의 14~44%, 그림 약 19~50%). ③ **남측 도로가 55% 지점에서 시작**합니다(도면 50%).
