...
(gpt-image-2.5-sunburst)에 주고 만든 **입체평면도**입니다(17회차).
...
비용은 17장 약 $0.76 입니다(16·17회차만 `xhigh` 품질이라 장당 $0.074).

## 프롬프트 — 마지막 회차(17회차, 참고: 색 배치도 + 배식설계도 + 13회차 그림)

13회차 그림을 함께 주고 고칠 둘만 적은 것입니다. 1~16회차 프롬프트는 뺐습니다.
    ...
    Two things are wrong. Fix exactly these two. Change nothing else at all.
