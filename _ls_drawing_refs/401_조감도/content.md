...
5. 11·12회차에 두 가지를 더 고쳤습니다 — ⑬ **진입광장 안내판을 제자리에서 90° 돌려** 판의 긴 변이
   포장과 관목이 만나는 경계선과 **나란해지게**(그 전에는 직각이라 어색했습니다) 하고, 관목을 등지고
   광장 안쪽을 바라보게 했습니다. ⑭ 빈 미색 판이 오히려 눈을 끌어, 판에 **읽히지 않을 만큼 흐린
   회색 무늬**(윗부분 작은 그림, 아래 글줄 두세 줄)를 넣어 질감을 주었습니다.
   안내판은 도면대로 **진입광장마다 하나씩**입니다
...
| 안내판 판면 | ✓ 아주 연한 미색에 **읽히지 않는 흐린 무늬** — 옆 포장과 비슷한 밝기라 도드라지지 않습니다 |
...
1회차 그림을 함께 주고 고칠 것을 한꺼번에 적은 것입니다. 1~19회차 프롬프트는 뺐습니다.
    ...
    12. THE BOARD PANELS ARE PALE OFF-WHITE WITH VERY FAINT, UNREADABLE MARKINGS.
    ...
    11. THE TWO ENTRANCE-PLAZA SIGNBOARDS: DIRECTION FIRST, THEN LEGS AND SHADOW.
