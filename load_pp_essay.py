...
CERTS = {
    '식물보호산업기사': ('산업기사', {
        ...
        # 26-1회도 기사와 마찬가지로 학원 배포 해설강의 PDF(정답 제거본)에서 옮겼다
        (2026, 1): '_pp_2026_1.json',
        (2026, 2): '_pp_2026_2.json',
    }),
    '식물보호기사': ('기사', {
        ...
        # 2026-1회는 학원 배포 해설강의 PDF(정답 제거본)에서 옮겼다. 20문항 모두
        # 복원돼 있고, 11번만 원본이 발문을 복원하지 못해 주제에 맞춰 다시 세웠다.
        (2026, 1): '_ppg_2026_1.json',
        (2026, 2): '_ppg_2026_2.json',
    }),
}
