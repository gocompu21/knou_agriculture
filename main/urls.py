...
urlpatterns = [
    ...
    path("subjects/<int:pk>/api/weed-quiz/next/", views.api_weed_quiz_next, name="api_weed_quiz_next"),
    ...
    path("subjects/<int:pk>/api/weed-card/fetch-photo/", views.api_weed_fetch_photo, name="api_weed_fetch_photo"),
