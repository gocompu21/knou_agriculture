...
**1회는 아직 다 복원되지 않았다** — 터파기·인부 계산 두 문항의 수치를 못 구해
번호 5·7 을 비워 두었다. 그래서 1회만 배점 합계 40점 검사를 걸지 않는다.
나중에 그 둘을 채우면 합계가 40점이 되도록 배점을 잡아 두었다.
"""
import io
import json
import os
...
ROUNDS = {
    1: ('_ls_2026_1.json', False,
        '계산 2문항(터파기·인부)의 수치를 못 구해 번호 5·7 을 비워 두었다 — 8점이 빈다'),
