...
- 진도율 옆 **오답율** 배지(`.sl-wrong`): 오답노트와 같은 기준(`wrong_review` 제외 최신 시도가 오답인 문항 수) ÷ 문항 수. 시험·과목별 + 상단 과목별 진도 카드(`오답 N문제 · N%`)에 표시
- 상단 **과목별 진도 카드**(`study_subject_stats`): 전 회차 합산 학습기록 ÷ 과목 문항 수, 진도 바는 100%에서 멈춤
