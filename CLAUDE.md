...
**구 체계 5과목 전부 완성·서버 배포 완료** (합계 880,534자, 기출 3,000문항 전수 연결).

| 과목 | 상태 | 분량 | 커버리지 |
|------|------|------|----------|
| 환경생태학개론 | ✅ 완성 | 144,468자 / 2,380줄 (12장+부록) | **600/600 (100%)** |
| 환경계획학 | ✅ 완성 | 218,185자 / 3,673줄 (12장+부록2) | **600/600 (100%)** |
| 생태복원공학 | ✅ 완성 | 173,614자 / 3,694줄 (12장+부록) | **600/600 (100%)** |
| 경관생태학 | ✅ 완성 | 188,395자 / 3,750줄 (9장+부록10) | **600/600 (100%)** |
| 자연환경관계법규 | ✅ 완성 | 155,872자 / 2,341줄 (9장+부록A~L) | **600/600 (100%)** |
| 생태환경조사분석 (신) | 미작성 | | 각 **220문항** (2022~2025) |
| 생태복원계획 (신) | 미작성 | | |
| 생태복원설계·시공 (신) | 미작성 | | |
| 생태복원 사후관리·평가 (신) | 미작성 | | |

서버 파싱 검증 결과 구 체계 5과목 모두 **빈 절 0개** (환경생태학개론 장13/절103, 환경계획학 장14/절136, 생태복원공학 장13/절94, 경관생태학 장10/절113, 자연환경관계법규 장10/절93).

> 2023~2025 기출 720문항이 들어오면서 **신 체계 4과목이 각 40 → 220문항**이 됐다. "문항이 적어 단독 노트 효율이 낮다"던 판단은 더 이상 유효하지 않으며, 이제 신 체계 노트를 만들 근거가 충분하다.
>
> 신 체계 노트를 쓸 때는 **문항뿐 아니라 출판사 해설(412,941자)까지 함께 재료로 넘긴다.** `dump_eco_questions.py`가 `[YYYY-R-N] 문제 / *정답보기 / [해설]` 형식으로 추출한다. 해설의 법조문·수치·표는 그대로 근거로 쓰고, 파편화된 해설을 하나의 체계로 엮고 배경을 보충하는 것이 에이전트의 몫이다.
