...
| `pesticide` 농약 DVD | **식물보호 두 급수만** — 농약명으로 살충제·살균제·제초제를 고르는 3지선다(92종). 쪽집게 노트 바로 다음 탭. 상세는 [docs/농약암기카드.md](docs/농약암기카드.md) |
| `pest` 해충 DVD | **식물보호 두 급수만** — 사진으로 해충 이름을 고르는 4지선다(152종, 농작물 108 · 수목 44). 농약 DVD 바로 다음 탭. 보기 넷은 서버가 **같은 구분에서 먼저** 만든다. 상세는 [docs/해충암기카드.md](docs/해충암기카드.md) |
